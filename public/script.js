      ...
      function($scope, $http) {
        ...
        $scope.fetch = function() {
          if ($scope.searchparam) {
            $scope.url = 'https://www.omdbapi.com/?apikey=6ab7f6ad&s=' + $scope.searchparam + '&type=movie&r=json'
            $http({
              method: $scope.method,
              url: $scope.url
            }).
            then(function(response) {
              if (response.data.Response) {
                ...
                angular.forEach(theSrchResults, function(obj) {
                  ...
                  $http({
                    method: $scope.method,
                    url: 'https://www.omdbapi.com/?apikey=6ab7f6ad&i=' + obj.imdbID + '&plot=full&r=json&tomatoes=false'
                  }).
                  then(function(response) {
